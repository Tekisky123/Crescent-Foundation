...
const ThreeCards = () => {
  ...
  return (
    <div className="cards-container">
      {!shouldHideCard("/blood-Center") &&( <Link to="/blood-Center"> <div className="card three">
      ...
      {!shouldHideCard("/Tcf-vocational-training-institute") &&(<Link to="/Tcf-vocational-training-institute"><div className="card three">
      ...
      {!shouldHideCard("/crescent-public-school") &&(<Link to="/crescent-public-school"><div className="card three">
     ...
     {!shouldHideCard("/crescent-clothing-center") &&( <Link to="/crescent-clothing-center"> <div className="card three">
